...
// export const sendRegistrationEmail = async (email: string, res: Response):Promise<void>=> {
...
export const sendRegistrationEmail = async (email: string,token:string): Promise<void> => { // Removed `res`
